...
const Footer = () => {
  return (
    <footer className="p-4 bg-light sm:p-6 dark:bg-dark">
      ...
      <div className="md:flex md:justify-between">
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 text-light dark:text-dark">
          <div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between text-light dark:text-dark">
        ...
        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
          <a
            href="#"
            className="text-light dark:text-dark hover:text-gray-400 dark:hover:text-gray-400"
          >
            <svg
              className="w-5 h-5"
              fill="currentColor"
